...
test_that("NLworldArray works similarly as NLstack",{
  ...
  expect_identical(attr(w5, "xmin"), attr(w2, "xmin"))
  expect_identical(attr(w5, "xmax"), attr(w2, "xmax"))
  expect_identical(attr(w5, "ymin"), attr(w2, "ymin"))
  expect_identical(attr(w5, "ymax"), attr(w2, "ymax"))
