...
test_that("patchDistHead works with patches", {
  w1 <- createNLworld(0, 9, 0, 9)
  p1 <- patchDistHead(world = w1, agents = cbind(pxcor = c(0, 1, 3), pycor = c(0, 1, 5)), dist = 3, angle = 45)
  expect_identical(p1, patch(w1, c(2, 3, 5), c(2, 3, 7)))
  p1 <- patchDistHead(world = w1, agents = cbind(pxcor = c(0, 1, 3), pycor = c(0, 1, 5)), dist = 3, angle = -45, torus = TRUE)
  p2 <- patchDistHead(world = w1, agents = cbind(pxcor = c(0, 1, 3), pycor = c(0, 1, 5)), dist = 3, angle = 315, torus = TRUE)
  ...
  w2[] <- runif(100)
  ws <- NLstack(w1, w2)
  p1 <- patchDistHead(world = ws, agents = cbind(pxcor = c(0, 1, 3), pycor = c(0, 1, 5)), dist = 3, angle = 45)
  expect_identical(p1, patch(ws, c(2, 3, 5), c(2, 3, 7)))
  p1 <- patchDistHead(world = ws, agents = cbind(pxcor = c(0, 1, 3), pycor = c(0, 1, 5)), dist = 3, angle = -45, torus = TRUE)
  p2 <- patchDistHead(world = ws, agents = cbind(pxcor = c(0, 1, 3), pycor = c(0, 1, 5)), dist = 3, angle = 315, torus = TRUE)
  ...
  w1 <- createNLworld(-5, 5, -5, 5)
  p1 <- patchDistHead(world = w1, agents = cbind(pxcor = c(0, -2, 3), pycor = c(0, 1, 5)), dist = 4, angle = 270, torus = TRUE)
  expect_identical(p1, patch(w1, c(-4, 5, -1), c(0, 1, 5)))
  p1 <- patchDistHead(world = w1, agents = cbind(pxcor = c(0, -2, 3), pycor = c(0, 1, 5)), dist = -4, angle = 270, torus = FALSE)
...
test_that("patchDistHead works with turtles", {
  ...
  p1 <- patchDistHead(world = w1, agents = t1, dist = 3, angle = 45)
  expect_identical(p1, patch(w1, c(2, 3, 5), c(2, 3, 7)))
  p1 <- patchDistHead(world = w1, agents = t1, dist = 3, angle = -45, torus = TRUE)
  p2 <- patchDistHead(world = w1, agents = t1, dist = 3, angle = 315, torus = TRUE)
  expect_identical(p1, patch(w1, c(8, 9, 1), c(2, 3, 7)))
  expect_identical(p1, p2)
  p1 <- patchDistHead(world = w1, agents = t1, dist = 3, angle = -45)
  expect_identical(p1, patch(w1, c(NA, NA, 1), c(NA, NA, 7), out = TRUE, duplicate = TRUE))
  ...
  w2[] <- runif(100)
  ws <- NLstack(w1, w2)
  p1 <- patchDistHead(world = ws, agents = t1, dist = 3, angle = 45)
  expect_identical(p1, patch(ws, c(2, 3, 5), c(2, 3, 7)))
  p1 <- patchDistHead(world = ws, agents = t1, dist = 3, angle = -45, torus = TRUE)
  p2 <- patchDistHead(world = ws, agents = t1, dist = 3, angle = 315, torus = TRUE)
  expect_identical(p1, patch(ws, c(8, 9, 1), c(2, 3, 7)))
  expect_identical(p1, p2)
  p1 <- patchDistHead(world = ws, agents = t1, dist = 3, angle = -45)
  expect_identical(p1, patch(ws, c(-2, -1, 1), c(-2, -1, 7), duplicate = TRUE, out = TRUE))
  ...
  p1 <- patchDistHead(world = w1, agents = t2, dist = 4, angle = 270, torus = TRUE)
  expect_identical(p1, patch(w1, c(-4, 5, -1), c(0, 1, 5)))
  p1 <- patchDistHead(world = w1, agents = t2, dist = -4, angle = 270, torus = FALSE)
  expect_identical(p1, patch(w1, c(4, 2, 7), c(0, 1, 5), duplicate = TRUE, out = TRUE))
})
