...
test_that("isTurtle works",{
  w1 <- createNLworld(minPxcor = 0, maxPxcor = 9, minPycor = 0, maxPycor = 9)
  t1 <- createTurtles(n = 10, coords = randomXYcor(world = w1, n = 10), breed = c(rep("sheep", 5), rep("wolf", 5)))
  expect_identical(isTurtle(turtles = t1, who = 3), TRUE)
  expect_identical(isTurtle(turtles = t1, who = 3, breed = "sheep"), TRUE)
  expect_identical(isTurtle(turtles = t1, who = 9, breed = "sheep"), FALSE)
  expect_identical(isTurtle(turtles = t1, who = 9, breed = "moose"), FALSE)
  expect_identical(isTurtle(turtles = t1, who = c(3, 9)), c(TRUE, TRUE))
  expect_identical(isTurtle(turtles = t1, who = c(3, 9), breed = "sheep"), c(TRUE, FALSE))
  expect_identical(isTurtle(turtles = t1, who = c(9, 3), breed = "sheep"), c(FALSE, TRUE))
  expect_identical(isTurtle(turtles = t1, who = c(3, 9), breed = c("wolf", "sheep")), c(FALSE, FALSE))
  expect_identical(isTurtle(turtles = t1, who = c(3, 9), breed = c("wolf", "wolf")), c(FALSE, TRUE))
  expect_identical(isTurtle(turtles = t1, who = c(3, 9), breed = "wolf"), c(FALSE, TRUE))
  expect_identical(isTurtle(turtles = t1, who = c(3, 9), breed = c("sheep", "wolf")), c(TRUE, TRUE))
  expect_identical(isTurtle(turtles = t1, who = c(3,11, 9)), c(TRUE, FALSE, TRUE))
  expect_identical(isTurtle(turtles = t1, who = c(3,11, 9), breed = "sheep"), c(TRUE, FALSE, FALSE))
  expect_identical(isTurtle(turtles = t1, who = c(3,11, 9), breed = c("sheep", "sheep", "wolf")), c(TRUE, FALSE, TRUE))
})
...
test_that("of works",{
  ...
  twho <- of(turtles = t, tVarName = "who")
  expect_equivalent(twho, 0:9)
  theading <- of(turtles = t, tVarName = "heading")
  expect_equivalent(theading, 21:30)
  tbreed <- of(turtles = t, tVarName = "breed")
  expect_equivalent(tbreed, rep("sheep", 10))
  tcolor <- of(turtles = t, tVarName = "color")
  expect_equivalent(tcolor, c(rep("blue", 5), rep("red", 5)))
  tprevCoords <- of(turtles = t, tVarName = "prevCoords")
  expect_equivalent(tprevCoords, cbind(prevX = rep(NA, 10), prevY = rep(NA, 10)))
  tprevX <- of(turtles = t, tVarName = "prevX")
  expect_equivalent(tprevX, rep(NA, 10))
  tprevY <- of(turtles = t, tVarName = "prevY")
  expect_equivalent(tprevY, rep(NA, 10))
  tcoords <- of(turtles = t, tVarName = "coords")
  expect_equivalent(tcoords, cbind(xcor = 1:10, ycor = 10:1))
  txcor <- of(turtles = t, tVarName = "xcor")
  expect_equivalent(txcor, 1:10)
  tycor <- of(turtles = t, tVarName = "ycor")
  expect_equivalent(tycor, 10:1)

  t1 <- turtlesOwn(turtles = t, tVarName = "age", tVar = c(2, 3, 4, 5, 2, 4, 6, 6, 3, 5))
  t1age <- of(turtles = t1, tVarName = "age")
  expect_equivalent(t1age, c(2, 3, 4, 5, 2, 4, 6, 6, 3, 5))

  t2who <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "who")
  expect_equivalent(t2who, 0)
  t2heading <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "heading")
  expect_equivalent(t2heading, 21)
  t2breed <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "breed")
  expect_equivalent(t2breed, "sheep")
  t2color <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "color")
  expect_equivalent(t2color, "blue")
  t2prevCoords <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "prevCoords")
  expect_equivalent(t2prevCoords, cbind(prevX = NA, prevY = NA))
  t2prevX <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "prevX")
  expect_equivalent(t2prevX, NA)
  t2prevY <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "prevY")
  expect_equivalent(t2prevY, NA)
  t2coords <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "coords")
  expect_equivalent(t2coords, cbind(xcor = 1, ycor = 10))
  t2xcor <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "xcor")
  expect_equivalent(t2xcor, 1)
  t2ycor <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "ycor")
  expect_equivalent(t2ycor, 10)
  t2age <- of(turtles = turtle(turtles = t1, who = 0), tVarName = "age")
