...
test_that("inRadius works",{
  ...
  # Turtles to turtles
  t8 <- inRadius(agents1 = turtle(t1, 0), radius = 1, agents2 = t1, world = w1)
  expect_identical(t8[[1]], turtle(t1, 0))
  t9 <- inRadius(agents1 = turtle(t1, 0), radius = 2, agents2 = t1, world = w1)
  expect_identical(t9[[1]], turtle(t1, c(0, 1)))
  t10 <- inRadius(agents1 = turtle(t1, 0), radius = 2, agents2 = t1, world = w1, torus = TRUE)
