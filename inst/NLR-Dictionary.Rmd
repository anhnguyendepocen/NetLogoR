...
* is-patch?: isNLclass() in NetLogoR
* s-patch-set?: isNLclass() in NetLogoR
* is-turtle?: isNLclass() in NetLogoR
...
* of: of() in NetLogoR to return turtles' variables. To return patches' variables, use world[pxcor, pycor] to display patch variables values for the requested patches with coordinates [pxcor, pycor].
...
* patch-at-heading-and-distance: patchDistHead() in NetLogoR
