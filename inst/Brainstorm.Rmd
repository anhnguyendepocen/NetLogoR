...
* B) Add a torus option to a few functions missing it (e.g., diffuse() but maybe others).

* c) Rename some of the parameters for consistency across NLR functions (e.g., step and distance, nDegrees and angle). Need to change it in all dependent functions and tests associated.

* D) Re-write properly the functions' documentation by using @inheritParams.
...
* G) Increase functions speed (e.g., removing "for loops"").
