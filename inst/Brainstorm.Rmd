...
* NLworldMs and agentMatrix to finish

* Add these new class as methods in the functions + unit tests.
...
* Define convert functions, raster <-> NLworldMs and SPDF <-> agentMatrix
