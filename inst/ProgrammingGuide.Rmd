...
In NetLogoR, the world is a `NLworlds` R object, either a `NLworld` or a `NLworldStack` R object. The world is two dimensional and is divided into a grid of square patches of resolution 1. 
