...
```{r, eval=FALSE}
...complete code <- "wolf" # the turtle number 0 which was "sheep" became "wolf"
...complete code <- "wolf" # confusing!
```
...
* Define the needed global variables. Global variables can be defined at any time in the code but it must be done before they are used.
