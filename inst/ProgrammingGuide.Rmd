...
In NetLogoR, the world is a `NLworldMs` R object, either a `worldMatrix` or a `worldArray` R object. The world is a matrix, or a collection of matrices which represents a two dimensional landscape, divided into a grid of square patches (i.e., matrix cells) of resolution 1. 
